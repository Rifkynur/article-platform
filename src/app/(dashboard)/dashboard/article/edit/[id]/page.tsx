...
const Page = () => {
  ...
  const { editArticle, getArticleById, articleById } = useHandleArticle();
  ...
  const form = useForm<FormSchema>({
    ...
    defaultValues: {
      ...
      category: articleById?.categoryId || "",
  ...
  useEffect(() => {
    if (articleById && articleById.title) {
      console.log(articleById);
      form.setValue("title", articleById.title);
      form.setValue("content", articleById.content);
      form.setValue("category", articleById.categoryId);
      form.setValue("image", undefined);
      if (articleById?.imageUrl) {
        setImagePreview(articleById.imageUrl);
      }
    }
  }, [articleById]);
  return (
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Controller control={form.control} name="content" render={({ field }) => <Editor value={field.value || ""} onChange={(value) => field.onChange(value)} />} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
